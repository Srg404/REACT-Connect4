...
function App() {
  ...
  const JSXshowTable = myTable.map(
    (el,index) => (
      <div key={index} style={{fontSize: "24px"}}>
        {el.map((el,index) => (
  ...
  return (
    <div className="App">
        {JSXshowTable}
        <button disabled={btDisable[0]} onClick={() => addValue(currentValue,0)}>0</button> 
        <button disabled={btDisable[1]} onClick={() => addValue(currentValue,1)}>1</button> 
        <button disabled={btDisable[2]} onClick={() => addValue(currentValue,2)}>2</button> 
        <button disabled={btDisable[3]} onClick={() => addValue(currentValue,3)}>3</button> 
        <button disabled={btDisable[4]} onClick={() => addValue(currentValue,4)}>4</button> 
        <button disabled={btDisable[5]} onClick={() => addValue(currentValue,5)}>5</button> 
        <button disabled={btDisable[6]} onClick={() => addValue(currentValue,6)}>6</button> 
